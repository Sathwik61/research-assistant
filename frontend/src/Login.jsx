...
const LoginPage = () => {
  ...
  const handleSubmit = (e) => {
    ...
    fetch(`https://pb698gh0-8000.inc1.devtunnels.ms/api/v1/login`, {
      method: "POST",
      headers: {
  ...
  const authgoogle = (parobj) => {
    fetch(`https://pb698gh0-8000.inc1.devtunnels.ms/api/v1/register`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  return (
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-custom-green-start to-custom-green-end py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-md w-full bg-white rounded-lg shadow-lg overflow-hidden ">
        <div className="px-6 py-8">
          ...
          {/* <h2 className="mt-6 silkscreen-regular"> */}
            {typedText}
          </h2>
          <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              <button
                type="submit"
                className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-gradient-to-r from-green-700 to-green-600 hover:from-green-700 hover:to-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-600 transition-all duration-300"
              >
                Sign in
              </button>
            </div>
